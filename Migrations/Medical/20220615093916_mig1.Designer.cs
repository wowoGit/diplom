...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("testing.Models.Activereferral", b =>
                {
            ...
            modelBuilder.Entity("testing.Models.Freepatients", b =>
                {
                    b.Property<DateTime>("DateofBirth")
                        .HasColumnType("timestamp without time zone")
                    ...
                    b.Property<string>("Patronymic")
                        .HasColumnType("text")
                        .HasColumnName("p_patro");

                    b.Property<string>("Pid")
                        .HasColumnType("text")
                        .HasColumnName("p_id");

                    b.ToTable("freepatients");
                });
            ...
            modelBuilder.Entity("testing.Models.Weekschedule", b =>
                {
                    ...
                    b.Property<DateTime?>("PatientBirth")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("p_birth");

                    b.Property<Gender?>("PatientGender")
                        .HasColumnType("gender")
                        .HasColumnName("gender");
            ...
            modelBuilder.Entity("testing.Models.Medcard", b =>
                {
                    b.HasOne("testing.Models.Manager", "Manager")
                        .WithMany("Medcards")
